    ...
    <div dir="rtl" className="container mx-auto  py-12 space-y-12">
      ...
      <main className="space-y-12">
        <Card className="shadow-lg rounded-lg overflow-hidden">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold text-muted-foreground">من نحن</CardTitle>
          </CardHeader>
        ...
        <Card className="shadow-lg rounded-lg overflow-hidden">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold text-muted-foreground">كيف يعمل</CardTitle>
          </CardHeader>
          <CardContent className="p-6">
            <p className="text-lg leading-relaxed dark:text-gray-200">
        ...
        <Card className="shadow-lg rounded-lg overflow-hidden">
          <CardHeader>
            <CardTitle className="text-2xl font-semibold text-muted-foreground">مميزات المعلم الافتراضي</CardTitle>
          </CardHeader>
          <CardContent className="p-6">
