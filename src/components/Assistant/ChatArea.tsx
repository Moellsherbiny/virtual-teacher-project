            ...
            >
              ...
              >
                ...
                >
                  <div
                    className={cn(
                      "px-4 py-2.5 shadow-sm break-words",
                      isUser
                        ? "bg-orange-600 text-white rounded-2xl rounded-tr-none"
                        : "bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-100 rounded-2xl rounded-tl-none border border-gray-200 dark:border-gray-800",
        ...
        <div className="relative flex items-center gap-2">
          ...
          >
            {isLoading ? (
              ...
              <Send className="w-4 h-4 ms-0.5 mt-0.5" />
            )}
          </Button>
        </div>
